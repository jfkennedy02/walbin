...
const contractAddress = '5aXs5m96u4NeiqoFcBjTTUyy6sVfoEReuBw1Az9JuAcm';
...
const addFloatingElements = () => {
    ...
    floatingElements.forEach((element, index) => {
        ...
        float.style.cssText = `
            ...
            font-size: 2rem;
            pointer-events: none;
            animation: floatRandom ${5 + Math.random() * 3}s ease-in-out infinite;
...
document.addEventListener('keydown', (e) => {
    ...
    if (JSON.stringify(konamiCode) === JSON.stringify(konami)) {
        ...
        specialToast.innerHTML = '<i class="fas fa-star"></i><span>🐋 Walbin loves you! 🐋</span>';
...
document.querySelectorAll('.hero, .about, .token-info, .community').forEach(section => {
